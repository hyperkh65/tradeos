  ...
  const handlePrint = () => {
    ...
    const printCss = `
      ...
      * { box-sizing: border-box; }
      body { margin: 0; padding: 0; font-family: "Noto Sans KR", Arial, sans-serif; background: white; color: #171717; }
    ...
    doc.open();
    doc.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${po.businessId}</title><style>${printCss}</style></head><body>${area.innerHTML}</body></html>`);
    doc.close();
    setTimeout(() => {
