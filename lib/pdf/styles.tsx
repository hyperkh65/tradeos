...
export const styles = StyleSheet.create({
  ...
  partyBox: { flex: 1, border: '1px solid #e0e0e0', borderRadius: 6 },
  ...
  th: { backgroundColor: '#f5f7fa', fontWeight: 700, fontSize: 8, padding: 5, borderRight: '1px solid #ddd', borderBottom: '1px solid #ddd', color: '#333' },
  td: { fontSize: 8, padding: 5, borderRight: '1px solid #ddd', borderBottom: '1px solid #ddd' },
